...
BASE_EXPORT bool AdjustStringForLocaleDirection(string16* text);
...
// BiDi character type.
BASE_EXPORT bool StringContainsStrongRTLChars(const string16& text);
...
BASE_EXPORT void WrapStringWithLTRFormatting(string16* text);
...
BASE_EXPORT void WrapStringWithRTLFormatting(string16* text);
...
// is returned.
BASE_EXPORT string16 GetDisplayStringInLTRDirectionality(const string16& text);
...
// pair.
BASE_EXPORT const string16 StripWrappingBidiControlCharacters(const string16& text);
}
} //namespace base
